...
class SaveMarketViewController : BaseViewController {
  ...
  //  var arr : Results<TraditionalMarketRealm>!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        arr = realmManager.myMarketCollectionList()
    }
...
extension SaveMarketViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let selectedMarket =  arr[indexPath.section].myFavorite[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return arr[section].myFavorite.count
    }
    ...
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        guard let arr else { return "" }
        return arr[section].marketName
    }

    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let arr else { return UITableViewCell()}
        ...
        let data = arr[indexPath.section].myFavorite[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        guard let arr else { return UISwipeActionsConfiguration()}
        let data = arr[indexPath.section].myFavorite[indexPath.row]
        ...
        let edit = UIContextualAction(style: .normal, title: "편집") { _, _, _ in
            ...
            let savedView = SavedDetailViewController()
            savedView.savedSelectedData = data

    ...
    func addDatas(markets: [Item]) {
        ...
        DispatchQueue.global().async {
            ...
            var UserInputMarketList: [TraditionalMarketRealm] = [
                ...
                TraditionalMarketRealm(marketName: "청취사", marketType: "5일장", loadNameAddress: "경기 성남시 중원구 둔촌대로 68", address: "경기 성남시 중원구 성남동 4931", marketOpenCycle: "4일+9일", publicToilet: "Y", latitude: "37.517742", longitude: "126.886463", popularProducts: "칼국수+죽류+돼지부속+잡화+원예+생활용품+의류", phoneNumber: "031-721-9905")
            ]
             ...
             * 모란민속5일장
                 * marketName: 모란민속5일장
                 * marketType: 5일장
                 * loadNameAddress: 전남 담양군 담양읍 담주4길 40,
                 * address: 전남 담양군 담양읍 담주리 7,
                 * marketOpenCycle: 4일+9일,
                 * publicToilet: “Y”,
                 * latitude: 37.428980,
                 * longitude: 127.127193,
                 * popularProducts: 칼국수+죽류+돼지부속+잡화+원예+생활용품+의류,
                 * phoneNumber: 031-721-9905

             */
            
            let allOfTraditionalMarket = traditionalMarkets + UserInputMarketList
